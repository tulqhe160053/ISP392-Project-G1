...
public class EditShipAddress extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ShipAddress s = dao.getById(ID);
        request.setAttribute("listS", s);
        
        DistrictDAO daol = new DistrictDAO();
        ArrayList<District> d = daol.selectAll();
        request.setAttribute("listD", d);
        CityDAO dal = new CityDAO();
        ArrayList<City> c = dal.selectAll();
        request.setAttribute("listC", c);
        
        request.getRequestDispatcher("/address/editshipaddress.jsp").forward(request, response);
        }
