<%-- 
    Document   : addbrand
    Created on : Mar 6, 2023, 2:24:08 PM
    Author     : thaib
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="login_form_inner">
                            <h3>Brand</h3>
                            <form class="row login_form" action="AddBrand" method="post" id="contactForm" novalidate="novalidate">
                                <div class="col-md-12 form-group">
                                    <input type="text" class="form-control" id="name" name="BrandName" placeholder="Brandname" >
                                </div>
