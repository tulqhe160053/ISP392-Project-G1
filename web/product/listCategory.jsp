            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                                <a href="" class="btn btn-success" data-toggle="modal"> <span>Add New Category</span></a>
                            </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <c:forEach items="${category}" var="c">
                        <tr>
                            ...
                            <td><a href="" class="edit" data-toggle="modal"><i class="icofont-ui-edit" data-toggle="tooltip" title="Edit">Edit  </i></a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
